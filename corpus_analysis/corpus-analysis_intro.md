...
Nachdem wir im vorherigen Kapitel das Vorgehen der automatischen linguistischen Annotation vorgestellt und unsere beiden Korpora literarischer Texte damit annotiert haben (siehe Kapitel [Korpusverarbeitung – Von Strings zu Token](corpus-processing_intro); die Annotation aller Texte selbst wurde aus Performanzgründen in ein Skript ausgelagert), sind alle Vorverarbeitungsschritte durchgeführt und wir wenden uns in diesem Kapitel der Korpusanalyse zu.
